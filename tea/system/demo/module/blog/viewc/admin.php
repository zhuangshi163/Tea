...
<div id="content">
    <div class="left">
        ...
        <div class="articles">
            <table>
              <tbody><tr>
                <th width="150"><a href="<?php echo $data['rootUrl']; ?>blog/post/sort/status/<?php echo $data['order']; ?>">Status</a></th>
                <th width="500"><a href="<?php echo $data['rootUrl']; ?>blog/post/sort/title/<?php echo $data['order']; ?>">Title</a></th>
                <th width="360"><a href="<?php echo $data['rootUrl']; ?>blog/post/sort/createtime/<?php echo $data['order']; ?>">Create Time</a></th>
              </tr>
              <?php foreach($data['posts'] as $k1=>$v1): ?>
              <tr class="trecord">
                <td><?php if( $v1->status==1 ): ?>Published<?php else: ?>Draft<?php endif; ?></td>
                <td><a href="<?php echo $data['rootUrl']; ?>blog/post/edit/<?php echo $v1->id; ?>"><?php echo $v1->title; ?></a></td>
