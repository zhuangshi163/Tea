 ...
 * @author darkredz
 */
class DefaultController extends TeaController{
	...
	public function gen_component(){
		Tea::loadCore('app/TeaSiteMagic');
		TeaSiteMagic::buildComponent();
	}
	
    public function gen_model(){
    	//$path = realpath('..').'/components/model/';
    	$path = Tea::conf()->SITE_PATH.'model/';
        Tea::loadCore('db/TeaModelGen');
        //TeaModelGen::genMySQL(true,true,'TeaModel',true,'Base',null,$path);
        TeaModelGen::genMySQL(true,true,'',false,'',null,$path);
    }
