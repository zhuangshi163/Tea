 ...
 * 
 * If you need to reverse generate URL based on route ID with TeaUrlBuilder in template view, please defined the id along with the routes
 ...
 * 
 * If you want a module to be publicly accessed (without using Tea::app()->getModule() ) , use [module name] ,   eg. /protected/module/forum/PostController.php
...
$route['*']['/'] = array('DefaultController', 'index');
...
$route['*']['/debug/:filename'] = array('Default/DefaultController', 'debug', 'authName'=>'Tea Admin', 'auth'=>$admin, 'authFail'=>'Unauthorized!');

//show all urls in app
$route['*']['/allurl'] = array('Default/DefaultController', 'allurl', 'authName'=>'Tea Admin', 'auth'=>$admin, 'authFail'=>'Unauthorized!');

//generate routes file. This replace the current routes.conf.php. Use with the sitemap tool.
$route['post']['/gen_sitemap'] = array('Default/DefaultController', 'gen_sitemap', 'authName'=>'Tea Admin', 'auth'=>$admin, 'authFail'=>'Unauthorized!');

//generate routes & controllers. Use with the sitemap tool.
$route['post']['/gen_sitemap_controller'] = array('Default/DefaultController', 'gen_sitemap_controller', 'authName'=>'Tea Admin', 'auth'=>$admin, 'authFail'=>'Unauthorized!');

//generate Controllers automatically
$route['*']['/gen_site'] = array('Default/DefaultController', 'gen_site', 'authName'=>'Tea Admin', 'auth'=>$admin, 'authFail'=>'Unauthorized!');

//generate Models automatically
$route['*']['/gen_model'] = array('Default/DefaultController', 'gen_model', 'authName'=>'Tea Admin', 'auth'=>$admin, 'authFail'=>'Unauthorized!');
*/


//view the logs and profiles XML, filename = db.profile, log, trace.log, profile
$route['*']['/debug/:filename'] = array('DefaultController', 'debug');

//show all urls in app
$route['*']['/allurl'] = array('DefaultController', 'allurl');

//generate routes file. This replace the current routes.conf.php. Use with the sitemap tool.
$route['post']['/gen_sitemap'] = array('DefaultController', 'gen_sitemap');

//generate routes & controllers. Use with the sitemap tool.
$route['post']['/gen_sitemap_controller'] = array('DefaultController', 'gen_sitemap_controller');

//generate Controllers automatically
$route['*']['/gen_site'] = array('DefaultController', 'gen_site');

//generate Models automatically
$route['*']['/gen_model'] = array('DefaultController', 'gen_model');
